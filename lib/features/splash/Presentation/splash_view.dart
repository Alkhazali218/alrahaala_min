...
class Arcpaint extends CustomPainter {
  ...
  void paint(Canvas Canvas, Size sixe) {
    Path orangeArc = Path()
      ..moveTo(0, 0)
      ..lineTo(0, sixe.height - 175)
      ..quadraticBezierTo(
          sixe.width / 2, sixe.height, sixe.width, sixe.height - 175)
      ..lineTo(sixe.width, sixe.height)
      ..lineTo(sixe.width, 0)
      ..close();
    ...
    Path whiteArc = Path()
      ..moveTo(0, 0)
      ..lineTo(0, sixe.height - 180)
      ..quadraticBezierTo(
          sixe.width / 2, sixe.height - 60, sixe.width, sixe.height - 180)
      ..lineTo(sixe.width, sixe.height)
      ..lineTo(sixe.width, 0)
      ..close();
